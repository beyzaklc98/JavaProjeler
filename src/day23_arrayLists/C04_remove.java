...
public class C04_remove {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(urunler.remove("Ikram")); // true -----> dondu ve ikrami sildi *****
        System.out.println(urunler); // [Nutella, Cekirdek, Cay]
        System.out.println(urunler.remove("Hobby")); // false -----> dondu cunku yoktu *****
        System.out.println(urunler); // [Nutella, Cekirdek, Cay]

        // ikinci yontemi deneyelim yani index girelim
        System.out.println(urunler.remove(1)); // Cekirdek -----> bunu dondurdu, cunku index, ve sildi *****
        System.out.println(urunler); // [Nutella, Cay]

        // olmayan bir indexi silmeye calisirsak ?
        // System.out.println(urunler.remove(3)); -----> hata aliriz
