...
public class C01_Mda {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(sayilar[0][1]); // 2 ----> 0. inner arrayin 1. index'i
        System.out.println(sayilar[1][0]); // 3  ----> 1. inner arrayin 0. index'i

        System.out.println(Arrays.toString(sayilar)); // [[I@58ceff1, [I@7c30a502] *****
        System.out.println(Arrays.deepToString(sayilar)); // [[1, 2, 4, 5], [3, 4]] ----> ic ice arrayde tum elemanlar
         /*
