...
public class C02_Child implements I01_InterfaceBodyOlanMethod{
    ...
    public String aku() {
     ...
     Bu iki farkli kelimenin amaci child class'lardan bu method'a nasil erisilebilecegini belirlemek icindir
     static keyword kullanilirsa , child class'dan bu method'a erismek icin InterfaceAdi.methodAdi yeterli olur
     default keyword kullanilirsa, method'a erismek icin obje olusturulmalidir.
     */
    public static void main(String[] args) {
        I01_InterfaceBodyOlanMethod.direksiyon(); // static olan bady

        C02_Child obj= new C02_Child(); // default olan bady
        obj.teker();
    }
}
