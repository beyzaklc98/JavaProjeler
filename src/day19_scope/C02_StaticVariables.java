...
public class C02_StaticVariables {
    ...
    public static void main(String[] args) {
       ...
       // objeler icin degil class icin gecerlidir
        ...
        staticMethod(); // burada static method cagirildi, oraya gitti ve sayi 10'du
                        // sayiyi yazdirdi ve orada method bitti tekrar buraya donus yapti
        staticSayi=12;
        System.out.println(staticSayi); // 12

        C02_StaticVariables obje1=new C02_StaticVariables();
        obje1.staticOlmayanMethod(); // static olmayan method cagirdik ama static olmadigi icin obje olusturduk
                                     // sonra java static olmayana gidecek ve sayiyi alip neyse buraya yazdiracak
